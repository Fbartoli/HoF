...
const main = async () => {
  ...
  let nft = await NFT.deploy('0x0000000000000000000000000000000000000000');
  console.log(
    " 📄",
    chalk.cyan("nft"),
    "deployed to:",
  ...
  try {
    await hre.run("verify:verify", { address: nft.address, constructorArguments: ['0x0000000000000000000000000000000000000000'] }, );
  } catch (error) {
    console.log(error)
  }
